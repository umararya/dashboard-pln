<?php
// pages/stock-perangkat-input.content.php
?>
...
<div class="card">
    <div class="card-header" style="display:flex;align-items:center;justify-content:space-between;gap:12px;">
        <div>
            <h2>➕ Input Stock Perangkat IT</h2>
            <p>Tambahkan data perangkat IT baru ke stock</p>
        </div>
    ...
    <div style="padding: 25px;">
        <form method="post" enctype="multipart/form-data">
            <input type="hidden" name="action" value="add_perangkat">
            ...
            <div class="sp-form-grid">
                <div class="form-group">
                    ...
                    <input type="text"
                           name="nama_barang"
                           value="<?= h($nama_barang) ?>"
                           placeholder="Contoh: Laptop, Keyboard, UPS"
                           required autofocus>
                </div>
                <div class="form-group">
                    ...
                    <input type="text"
                           name="type_barang"
                           value="<?= h($type_barang) ?>"
                           placeholder="Contoh: Dell Latitude 5520, Logitech MK270">
                </div>
            </div>
            ...
            <div class="form-group" style="max-width:500px;">
                ...
                <input type="text"
                       name="supplai"
                       value="<?= h($supplai) ?>"
                       placeholder="Nama vendor / sumber pengadaan barang">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="keterangan" rows="4"
                          placeholder="Catatan tambahan: lokasi penyimpanan, nomor seri, dll."><?= h($keterangan) ?></textarea>
            </div>
